...
function BodyReader(options) {
    ...
    function readOle(imageFile, altText) {
        var contentType = contentTypes.findContentType(imageFile.path);
        var image = documents.Image({
            readImage: imageFile.read,
            altText: altText,
            contentType: 'oleObject'
        });
    ...
    function findEmbeddedOleFile(relationshipId) {
    ...
    function readOleElement(element) {
        var relationshipId = element.attributes['r:id'];
        if (relationshipId) {
            return readOle(
                findEmbeddedOleFile(relationshipId),
    ...
    var xmlElementReaders = {
        ...
        // ole部分的处理
        "{urn:schemas-microsoft-com:office:office}OLEObject": readOleElement,
